...
function load_marker(list){
	...
	var a = {
		"1":{
			icon: "/web/images/marker-2.png",
			rank: "三型一化A级厅"
		},
		"2":{
			icon: "/web/images/marker-1.png",
			rank: "三型一化B级厅"
		},
		"3":{
			icon: "/web/images/marker-4.png",
			rank: "三型一化C级厅"
		},
		"4":{
			icon: "/web/images/marker-3.png",
			rank: "非三型一化厅"
		}
	}
	...
	function add_marker(item){
		...
		var content = ` <div class="map-info-window">
							<div class="left">
								<div class="img"><img src="/web/images/demo-1.jpg"></div>
								<p>${distance}</p>
							</div>
							<div class="det">
								<table>
